...
Source Server         : what'supman
Source Server Version : 50624
Source Host           : 127.0.0.1:3306
Source Database       : rszdm
...
-- ----------------------------
-- Table structure for rszdm
-- ----------------------------
DROP TABLE IF EXISTS `casio5610`;
CREATE TABLE `casio5610` (
  `objectID` int(11) NOT NULL AUTO_INCREMENT,
  `price` varchar(20) DEFAULT NULL,
  `date` varchar(20) DEFAULT NULL,
  `sourceSite` varchar(20) DEFAULT NULL,
